        ...
        <div className="bg-white rounded-lg shadow-sm p-12">
          ...
          <div className="space-y-8 text-slate-700 leading-relaxed">
            <section>
              ...
              <p>We are committed to protecting your privacy and ensuring you have a positive experience on our website and when using our services. This policy outlines how we collect, use, and protect your personal information.</p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">3. Automatically Collected Information</h2>
            ...
            <section>
              ...
              <ul className="list-disc list-inside mt-4 space-y-2">
                <li>Service providers who assist in operations (payment processors, delivery partners)</li>
            ...
            <section>
              ...
              <p>We use cookies to enhance your experience. You can control cookie settings through your browser. Disabling cookies may affect site functionality.</p>
            </section>
            ...
            <section>
              ...
              <p>Our website may contain links to third-party websites. We are not responsible for the privacy practices of external sites. Please review their policies before providing personal information.</p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">10. Changes to This Policy</h2>
              <p>We may update this privacy policy periodically. Changes become effective upon posting to our website. Continued use of our services constitutes acceptance of updated terms.</p>
            </section>
